...
import { Button, ButtonColor, type ButtonProps, ButtonVariant } from "shared/ui/button";
...
export const LoginButtonIcon: React.FC<LoginButtonIconProps> = ({ ...props }) => {
  return (
    <Button variant={ButtonVariant.ICON} color={ButtonColor.SECONDARY} title="Перейти к авторизации" {...props}>
